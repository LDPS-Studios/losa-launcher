			...
			switch (ChipID.Family) {
				...
				case 6:
					switch (ChipID.Model) {
						...
						case 3: STORE_CLASSICAL_NAME ("PentiumII (0.28)"); break;
						case 5: STORE_CLASSICAL_NAME ("PentiumII (0.25)"); break;
						case 6: STORE_CLASSICAL_NAME ("PentiumII With On-Die L2 Cache"); break;
						case 7: STORE_CLASSICAL_NAME ("PentiumIII (0.25)"); break;
						case 8: STORE_CLASSICAL_NAME ("PentiumIII (0.18) With 256 KB On-Die L2 Cache "); break;
						case 0xa: STORE_CLASSICAL_NAME ("PentiumIII (0.18) With 1 Or 2 MB On-Die L2 Cache "); break;
						case 0xb: STORE_CLASSICAL_NAME ("PentiumIII (0.13) With 256 Or 512 KB On-Die L2 Cache "); break;
				...
				case 0xf:
					...
					switch (ChipID.ExtendedFamily) {
						case 0:
							switch (ChipID.Model) {
								case 0: STORE_CLASSICAL_NAME ("PentiumIV (0.18)"); break;
								case 1: STORE_CLASSICAL_NAME ("PentiumIV (0.18)"); break;
								case 2: STORE_CLASSICAL_NAME ("PentiumIV (0.13)"); break;
					...
					switch (ChipID.Model) {
						...
						case 8: 
							if (Features.ExtendedFeatures.SupportsMP)
								STORE_CLASSICAL_NAME ("AthlonMP (Thoroughbred core)"); 
							else STORE_CLASSICAL_NAME ("AthlonXP (Thoroughbred core)");
							break;
